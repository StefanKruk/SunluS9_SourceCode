#line 1 "/mnt/hgfs/SVN/Marlin-2.0.x/Marlin/src/lcd/extui/ui_api.h"
/**
...
namespace ExtUI {
  ...
  enum heater_t   : uint8_t { H0, H1, H2, H3, H4, H5, BED, CHAMBER, COOLER,DRYBOX };
  ...
  void enqueue_one_now(char * const);
  bool enqueue_one_P(PGM_P const gcode);
