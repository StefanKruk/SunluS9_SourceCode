#line 1 "/mnt/hgfs/SVN/Marlin-2.0.x/Marlin/src/lcd/dogm/HAL_LCD_class_defines.h"
/**
...
public:
  ...
  void init(uint8_t options = U8G_I2C_OPT_NONE) { U8GLIB(&u8g_dev_sh1106_128x64_2x_i2c_2_wire, options); }
};
...
public:
  ...
  void init(uint8_t options = U8G_I2C_OPT_NONE) { U8GLIB(&u8g_dev_ssd1306_128x64_2x_i2c_2_wire, options); }
};
...
public:
  ...
  void init(uint8_t cs, uint8_t rs, uint8_t reset = U8G_PIN_NONE) { U8GLIB(&u8g_dev_tft_320x240_upscale_from_128x64, cs, rs, reset); }
};
