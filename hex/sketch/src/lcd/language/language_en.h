#line 1 "/mnt/hgfs/SVN/Marlin-2.0.x/Marlin/src/lcd/language/language_en.h"
/**
...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_CHECK_SD                        = _UxGT("Please Check SD card");//zb
  PROGMEM Language_Str MSG_ERROR_SD                        = _UxGT("SD ERROR");//zb
  PROGMEM Language_Str MSG_ERROR_Leveling                  = _UxGT("Leveling Device ERROR");//zb
  PROGMEM Language_Str MSG_CHECK_Leveling                  = _UxGT("Please Check Leveling Device");//zb
  PROGMEM Language_Str MSG_SOTFWARE_VERSION                = _UxGT("V1.00.16.00.01.00.01");//zb SV DWSV HV
  PROGMEM Language_Str MSG_PRINT_INFO_FIRST                = _UxGT("code:ONE");//zb
  PROGMEM Language_Str MSG_PRINT_INFO_SECOND               = _UxGT("code:SECOND");//zb
  PROGMEM Language_Str MSG_PRINT_INFO_THIRD                = _UxGT("code:THIRD");//zb
  PROGMEM Language_Str MSG_PRINT_INFO_FOURTH               = _UxGT("code:FOURTH");//zb
  PROGMEM Language_Str MSG_ERROR_PRINT                     = _UxGT("Print Error");//zb
  PROGMEM Language_Str MSG_ERROR_SCREEN_FRESH              = _UxGT("Screen Refresh Failed");//zb
  
  PROGMEM Language_Str MSG_ERROR_ADDR1                     = _UxGT("Address111");//zb
  PROGMEM Language_Str MSG_ERROR_ADDR2                     = _UxGT("Address222");//zb
  PROGMEM Language_Str MSG_ERROR_ADDR3                     = _UxGT("Address333");//zb
  PROGMEM Language_Str MSG_ERROR_ADDR4                     = _UxGT("Address444");//zb
