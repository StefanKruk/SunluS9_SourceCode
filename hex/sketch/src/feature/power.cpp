#line 1 "/mnt/hgfs/SVN/Marlin-2.0.x/Marlin/src/feature/power.cpp"
/**
...
bool Power::is_power_needed() {
  ...
  #if HAS_DRYBOX
  if (TERN0(HAS_HEATED_DRYBOX, thermalManager.degTargetHotend_drybox(TEMP_DRYBOX_CENTER_PIN)() > 0 || thermalManager.temp_drybox_center_hotend[0].soft_pwm_amount > 0)) return true;
  #endif
