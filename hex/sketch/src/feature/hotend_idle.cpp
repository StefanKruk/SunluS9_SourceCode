#line 1 "/mnt/hgfs/SVN/Marlin-2.0.x/Marlin/src/feature/hotend_idle.cpp"
/**
...
void HotendIdleProtection::timed_out() {
  ...
  HOTEND_LOOP() {
    ...
    if ((HOTEND_IDLE_DRYBOX_TARGET) < thermalManager.degTargetHotend_drybox(TEMP_DRYBOX_CENTER_PIN))
      thermalManager.setTargetHotend(HOTEND_IDLE_BED_TARGET);
  #endif
}
