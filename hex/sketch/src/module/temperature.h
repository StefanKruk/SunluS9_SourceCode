#line 1 "/mnt/hgfs/SVN/Marlin-2.0.x/Marlin/src/module/temperature.h"
/**
...
#endif
#define  drybox_MaxTime    (99L*60L*60L)

#define HOTEND_INDEX 0//TERN(HAS_MULTI_HOTEND, e, 0)
#define E_NAME TERN_(HAS_MULTI_HOTEND, e)

// Element identifiers. Positive values are hotends. Negative values are other heaters or coolers.
typedef enum : int8_t {
  H_NONE = -6,
  H_COOLER, H_PROBE, H_REDUNDANT, H_CHAMBER, H_BED,H_DRYBOX,H_DRYBOX_RTH,
...
#ifdef HAS_DRYBOX
#define _PID_Kp_drybox(H) TERN(PIDTEMP, Temperature::temp_drybox_center_hotend[H].pid.Kp, NAN)
#define _PID_Ki_drybox(H) TERN(PIDTEMP, Temperature::temp_drybox_center_hotend[H].pid.Ki, NAN)
#define _PID_Kd_drybox(H) TERN(PIDTEMP, Temperature::temp_drybox_center_hotend[H].pid.Kd, NAN)
#endif
...
enum ADCSensorState : char {
  ...
  //darbox
    ...
    PrepareTemp_DRYBOX_RTH, MeasureTemp_DRYBOX_RTH,
  #endif
...
//drybox
  ...
  public:
    ...
    static inline celsius_float_t degHotend_DRYBOX(uint8_t E_NAMEa) {
    	switch(E_NAMEa)
    	{
    		case TEMP_DRYBOX_CENTER_PIN:
      			return TERN0(HAS_TEMP_DRYBOX_CENTER, temp_drybox_center_hotend[0].celsius);
			break;
			default:
			break;
    	}
    ...
    static inline celsius_t degTargetHotend_drybox(uint8_t E_NAMEa) {
		//uint8_t NAME=E_NAMEa;
		switch(E_NAMEa)
		{
			case TEMP_DRYBOX_CENTER_PIN:
      			return TERN0(HAS_TEMP_DRYBOX_CENTER, temp_drybox_center_hotend[0].target);
			break;
		}
    }
