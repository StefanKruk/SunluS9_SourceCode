#line 1 "/mnt/hgfs/SVN/Marlin-2.0.x/Marlin/src/module/thermistor/thermistors.h"
/**
...
#ifdef TEMP_SENSOR_DRYBOX_THERMISTOR_ID
#define TEMPTABLE_DRYBOX TT_NAME(TEMP_SENSOR_DRYBOX_THERMISTOR_ID)
#define TEMPTABLE_DRYBOX_LEN COUNT(TEMPTABLE_DRYBOX)
#endif



#ifdef TEMP_SENSOR_DRYBOX_RTH_THERMISTOR_ID
#define TEMPTABLE_DRYBOX_RTH TT_NAME(TEMP_SENSOR_DRYBOX_RTH_THERMISTOR_ID)
#define TEMPTABLE_DRYBOX_RTH_LEN COUNT(TEMPTABLE_DRYBOX_RTH)
#endif

#ifdef TEMP_SENSOR_DRYBOX_PH_THERMISTOR_ID
#define TEMPTABLE_DRYBOX_PH TT_NAME(TEMP_SENSOR_DRYBOX_PH_THERMISTOR_ID)
#define TEMPTABLE_DRYBOX_PH_LEN COUNT(TEMPTABLE_DRYBOX_PH)
#endif
