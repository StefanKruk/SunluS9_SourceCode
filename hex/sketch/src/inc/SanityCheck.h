#line 1 "/mnt/hgfs/SVN/Marlin-2.0.x/Marlin/src/inc/SanityCheck.h"
/**
 ...
 */
  ...
  + COUNT_ENABLED(DGUS_LCD_UI_ORIGIN, DGUS_LCD_UI_FYSETC, DGUS_LCD_UI_HIPRECY, DGUS_LCD_UI_MKS,DGUS_LCD_UI_SUNLU) \
