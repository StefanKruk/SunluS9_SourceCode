#line 1 "/mnt/hgfs/SVN/Marlin-2.0.x/Marlin/src/inc/Conditionals_post.h"
/**
...
#if TEMP_SENSOR_DRYBOX_CENTER>0

#define TEMP_SENSOR_DRYBOX_THERMISTOR_ID TEMP_SENSOR_DRYBOX_CENTER
#define TEMP_SENSOR_DRYBOX_IS_THERMISTOR 1


#define TEMP_SENSOR_DRYBOX_RTH_THERMISTOR_ID TEMP_SENSOR_DRYBOX_RTH
#define TEMP_SENSOR_DRYBOX_RTH_IS_THERMISTOR 1

#define TEMP_SENSOR_DRYBOX_PH_THERMISTOR_ID TEMP_SENSOR_DRYBOX_PH
#define TEMP_SENSOR_DRYBOX_PH_IS_THERMISTOR 1
...
//drybox
#if PIN_EXISTS(TEMP_DRYBOX_PH)
  #define HAS_TEMP_DRYBOX_PH 1
#endif
#if HAS_ADC_TEST(DRYBOX_RTH)
  #define HAS_TEMP_DRYBOX_RTH 1
#endif
#if HAS_ADC_TEST(DRYBOX_CENTER)
  #define HAS_TEMP_DRYBOX_CENTER 1
#endif
...
#if PIN_EXISTS(HEATER_DRYBOX)
  #define HAS_HEATED_DRYBOX 1
#endif
...
// Thermal protection
  ...
  #define WATCH_DRYBOX_CENTER	1
#endif
#if ENABLED(THERMAL_PROTECTION_DRYBOX_RTH)
  #define WATCH_DRYBOX_RTH	1
#endif
...
// Auto fans
  ...
  #define HAS_AUTO_DRYBOX_FAN 1
#endif

#if ANY(HAS_AUTO_FAN_0, HAS_AUTO_FAN_1, HAS_AUTO_FAN_2, HAS_AUTO_FAN_3, HAS_AUTO_FAN_4, HAS_AUTO_FAN_5, HAS_AUTO_FAN_6, HAS_AUTO_FAN_7, HAS_AUTO_CHAMBER_FAN, HAS_AUTO_COOLER_FAN,HAS_AUTO_DRYBOX_FAN)
...
#define WRITE_HEATER_0P(v) WRITE(HEATER_0_PIN, (v) ^ HEATER_0_INVERTING)
  ...
  #ifndef MIN_DRYBOX_POWER
    #define MIN_DRYBOX_POWER 0
  #endif
  #ifndef MAX_DRYBOX_POWER
    #define MAX_DRYBOX_POWER 255
  #endif
  #ifndef HEATER_DRYBOX_INVERTING
    #define HEATER_DRYBOX_INVERTING false
  #endif
  #define WRITE_HEATER_DRYBOX(v) WRITE(HEATER_DRYBOX_PIN, (v) ^ HEATER_DRYBOX_INVERTING)
#endif
